...
export default function Header({ cols }) {
    ...
    return (_jsx(Box, { flexDirection: "column", paddingX: 2, children: _jsxs(Box, { flexDirection: "row", alignItems: "flex-start", children: [showPhoto && (_jsx(Box, { marginRight: 4, children: _jsx(Text, { children: asciiPhoto }) })), _jsxs(Box, { flexDirection: "column", children: [_jsx(Box, { flexDirection: "column", children: nameLines.map((line, i) => (_jsx(Text, { color: hslToHex((i * 35 + phase * 6) % 360, 100, 62), children: line }, i))) }), _jsx(Text, { color: "gray", children: "Aspiring full-stack dev \u2014 cloud infrastructure, AI architecture, system design" }), _jsx(Text, { children: " " }), _jsx(Text, { bold: true, color: "cyan", children: "About Me" }), _jsx(Text, { children: '─'.repeat(60) }), _jsx(Text, { children: " " }), _jsx(Text, { children: "Early-career Software Engineer with experience building secure and scalable systems across backend infrastructure, distributed services, and applied cryptography. Strong foundation in systems programming, software design, and concurrent architectures." }), _jsx(Text, { children: " " }), _jsx(Text, { children: "My goal is to become a cloud engineer delivering top-end IaaS solutions. I love working at the intersection of hardware and software \u2014 low-latency pipelines, distributed systems, and polished user experiences." })] })] }) }));
}
