...
function App() {
    ...
    return (_jsxs(Box, { flexDirection: "column", children: [_jsxs(Box, { flexDirection: "row", borderStyle: "single", borderBottom: true, paddingX: 1, children: [SECTIONS.map((s, i) => (_jsx(Box, { marginRight: i < SECTIONS.length - 1 ? 3 : 0, children: _jsx(Text, { color: s === active ? 'cyan' : undefined, dimColor: s !== active, bold: s === active, children: s === active ? `[ ${LABELS[s]} ]` : LABELS[s] }) }, s))), _jsx(Box, { flexGrow: 1 }), _jsx(Text, { dimColor: true, children: "\u2190 \u2192 Tab  q:quit" })] }), _jsxs(Box, { marginTop: 1, children: [active === 'header' && _jsx(Header, {}), active === 'experience' && _jsx(Experience, { isActive: active === 'experience' }), active === 'contact' && _jsx(Contact, {})] })] }));
}
render(_jsx(App, {}));
